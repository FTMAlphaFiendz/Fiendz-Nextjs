...
const genesisCollection = () => {
  return (
    <>
      <div className="flex flex-col lg:flex-row mx-auto h-full w-full justify-center items-center md:place-items-center min-h-full rarity-bg relative">
        <Waves fillColor="#fedf87" />
        <div className="flex flex-col items-center justify-center">
          <header className="xs:mt-20 mt-20 2xl:mt-10 mb-5 text-center w-10/12">
            <h1 className="font-freckle text-4xl sm:text-6xl md:text-7xl text-border page-title">
              GENESIS FIENDZ
            </h1>
          </header>
      ...
      <div
        id="team"
        className="flex flex-col mx-auto h-full w-full justify-center items-center md:place-items-center min-h-full footer-bg-y relative p-10 "
      >
        <div className="flex flex-wrap justify-center items-center mt-3">
          <MainButton link={nftKeyLink} icon={<GoKey />} text="NFT KEY" />
          <MainButton
            link={campfireLink}
            icon={<GiCampfire />}
            text="CAMPFIRE"
